...
const STRINGS = {
  ...
  'time.m': ['{m}m', '{m} דקות'],
  'time.today': ['updated today', 'עודכן היום'],
  'time.oneDayAgo': ['updated 1 day ago', 'עודכן לפני יום'],
  'time.daysAgo': ['updated {n} days ago', 'עודכן לפני {n} ימים'],
  ...
  'common.all': ['All', 'הכל'],
  'common.allClubs': ['All clubs', 'כל הקבוצות'],
  'common.playerProfile': ['Player profile', 'פרופיל שחקן'],
  'common.nGws': ['{n} GWs', '{n} מחזורים'],
  'pl.seasonHorizon': ['Season', 'כל העונה'],
  'common.showMore': ['Show more', 'הצג עוד'],
  'common.horizon': ['Horizon', 'טווח תכנון'],
  'common.xpNext': ['xP Next', 'צפי הבא'],
  'common.xpHorizon': ['xP ({n})', 'צפי ({n})'],
  'common.customHorizon': ['Custom', 'מותאם אישית'],
  'common.customHorizonTitle': ['Number of gameweeks ahead to project', 'מספר מחזורים קדימה לחישוב הצפי'],
  'common.xpNextTitle': ['amitfpl model - expected points next gameweek', 'מודל amitfpl - נקודות צפויות במחזור הבא'],
  'common.xpHorizonTitle': ['amitfpl model - expected points over the next {n} gameweeks', 'מודל amitfpl - נקודות צפויות ב-{n} המחזורים הבאים'],
  ...
  'pl.undo': ['Undo', 'בטל'],
  'pl.redo': ['Redo', 'בצע שוב'],
  'pl.undoTitle': ['Undo the last squad/lineup change (re-optimize, transfer, swap, captain, chip...)', 'בטל את השינוי האחרון בסגל/הרכב (אופטימיזציה מחדש, העברה, החלפה, קפטן, צ׳יפ...)'],
  'pl.redoTitle': ['Redo the change you just undid', 'בצע שוב את השינוי שביטלת'],
  'pl.formation': ['Formation', 'פורמציה'],
  'pl.formationAuto': ['Auto', 'אוטומטי'],
  'pl.formationTitle': ['Lock the XI to this formation instead of auto-picking the highest-scoring one', 'נעילת ההרכב הפותח לפורמציה הזו במקום בחירה אוטומטית של הפורמציה עם הניקוד הגבוה ביותר'],
  'pl.buildMode': ['Build', 'בנייה'],
  'pl.buildModeTitle': ['What auto-build optimizes for', 'לפי מה הבנייה האוטומטית מייעלת'],
  'pl.buildModeXp': ['Best xP', 'צפי מקסימלי'],
  'pl.buildModeOwned': ['Most owned', 'הכי מוחזק'],
  'pl.buildModeDiff': ['Most differential', 'הכי דיפרנציאלי'],
  'pl.optimizing': ['Optimizing…', 'מבצע אופטימיזציה…'],
  'pl.buildOpts': ['Auto-build gave you these squads:', 'הבנייה האוטומטית הכינה את ההרכבים הבאים:'],
  'pl.buildOptN': ['Squad {n}', 'הרכב {n}'],
  'info.buildOpts': ['With Formation set to Auto, these are real squads for the same budget - one built and planned for a 3-GW push, one for 5, one for 8, one for the rest of the season - each with its own true forecast and its own simulated transfer-and-chip plan for that horizon (check the GW tabs and chip bar after picking one). The season plan also simulates 2 Wildcards and a Free Hit alongside Triple Captain/Bench Boost - Free Hit only shows up once FPL actually confirms a blank gameweek, which isn’t known yet this early in the season. Lock a specific formation first and these become three jittered takes on that one shape instead. Tap to switch, fine-tune on the pitch.', 'כשהפורמציה על אוטומטי, אלה הרכבים אמיתיים לאותו תקציב - אחד בנוי ומתוכנן ל-3 מחזורים, אחד ל-5, אחד ל-8, ואחד לכל שאר העונה - כל אחד עם הצפי האמיתי שלו ותוכנית חילופים וצ׳יפים משלו לאותו אופק (בודקים בלשוניות המחזורים ובשורת הצ׳יפים אחרי הבחירה). תוכנית העונה גם מדמה 2 וויילדקארדים ופרי היט, בנוסף לטריפל קפטן/בנץ׳ בוסט - פרי היט יופיע רק כשFPL בפועל מאשרים בלנק, ואת זה עדיין לא יודעים כך מוקדם בעונה. נועלים פורמציה מסוימת מראש ואז אלה הופכים לשלוש גרסאות של אותה פורמציה. מקישים כדי להחליף, מלטשים על המגרש.'],
  ...
  'pl.shareImage': ['Screenshot', 'צילום מסך'],
  'pl.shareImageTitle': ['Save the starting XI and bench as an image', 'שמירת ההרכב והספסל כתמונה'],
  'pl.shareImageWorking': ['Capturing…', 'מצלם…'],
  'pl.shareImageError': ['Couldn’t capture - try again', 'הצילום נכשל - נסו שוב'],
  'pl.copy': ['Copy', 'העתקה'],
  ...
  'pl.lineupAll': ['Starts + Bench', 'מתחילים + ספסל'],
  ...
  'pl.asSubtitleSeason': ['· amitfpl xP model · rest-of-season plan incl. transfer hits', '· מודל הצפי של amitfpl · תוכנית לכל שאר העונה כולל קנסות העברה'],
  ...
  'pl.cmpNote': ['● marks the active draft. Switch drafts with the buttons in the toolbar - click a name above to rename it.', '● מסמן את הטיוטה הפעילה. מחליפים טיוטה עם הכפתורים בסרגל - לוחצים על שם מעל כדי לשנות אותו.'],
  ...
  'an.lineupSwap': ['Lineup: start <strong>{in}</strong> instead of {out} (+{gain} xP this GW).', 'הרכב: הכניסו את <strong>{in}</strong> במקום {out} (‎+{gain} צפי במחזור).'],
  'an.xiTitle': ['The recommended XI ({formation}, +{gain} xP in total):', 'ההרכב המומלץ ({formation}, ‎+{gain} צפי בסך הכל):'],
